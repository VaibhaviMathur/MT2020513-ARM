...
int *SP = (&stack[0]);       //stack pointer pointing to start of array


void push(int data)
{
 if((SP-start)==SIZE)          //if stack pointer points address above array     
...
int pop()
{
 ...
 if(SP==start)         //if stack pointer points to first element of array
 { 
